...
const VehiclePanel = (props) => {
  return (
    <div>
        ...
        <div className="flex items-center justify-center gap-4 w-full p-3 border-2 active:border-black rounded-lg mb-3">
          <img
        ...
        <div className="flex items-center justify-center gap-4 w-full p-3 border-2 active:border-black rounded-lg">
          <img
